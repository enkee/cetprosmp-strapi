  ...
  <main>
    <Container sx={{ pt: 5, mb: 6 }}>
      ...
      {carrerasConCodigo?.length > 0 && (
        <Box mt={8}>
          <Typography variant="h4" component="h2" gutterBottom sx={{fontWeight: 'bold', fontSize: 'clamp(1.5rem, 5vw, 2rem)', textAlign: {xs:'center', md:'left'}}}>
            Carreras
          </Typography>
