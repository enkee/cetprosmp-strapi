...
ALTER TABLE public."act-economicas" OWNER TO postgres;
...
ALTER SEQUENCE public."act-economicas_id_seq" OWNER TO postgres;
...
ALTER TABLE public.act_economicas_especialidad_lnk OWNER TO postgres;
...
ALTER SEQUENCE public.act_economicas_especialidad_lnk_id_seq OWNER TO postgres;
...
ALTER TABLE public.act_economicas_familia_lnk OWNER TO postgres;
...
ALTER SEQUENCE public.act_economicas_familia_lnk_id_seq OWNER TO postgres;
...
ALTER SEQUENCE public.calendarios_id_seq OWNER TO postgres;
...
ALTER TABLE public.calendarios_semestre_lnk OWNER TO postgres;
...
ALTER SEQUENCE public.calendarios_semestre_lnk_id_seq OWNER TO postgres;
...
ALTER TABLE public.carreras_act_economica_lnk OWNER TO postgres;
...
ALTER SEQUENCE public.carreras_act_economica_lnk_id_seq OWNER TO postgres;
...
ALTER TABLE public.components_video_youtubes OWNER TO postgres;
...
ALTER SEQUENCE public.components_video_youtubes_id_seq OWNER TO postgres;
...
ALTER TABLE public.dato_general OWNER TO postgres;
...
ALTER SEQUENCE public.dato_general_id_seq OWNER TO postgres;
...
ALTER TABLE public.familias_sector_lnk OWNER TO postgres;
...
ALTER SEQUENCE public.familias_sector_lnk_id_seq OWNER TO postgres;
...
ALTER TABLE public.grupos_calendario_lnk OWNER TO postgres;
...
ALTER SEQUENCE public.grupos_calendario_lnk_id_seq OWNER TO postgres;
...
ALTER TABLE public.grupos_modulo_lnk OWNER TO postgres;
...
ALTER SEQUENCE public.grupos_modulo_lnk_id_seq OWNER TO postgres;
...
ALTER TABLE public.grupos_personal_lnk OWNER TO postgres;
...
ALTER SEQUENCE public.grupos_personal_lnk_id_seq OWNER TO postgres;
...
ALTER TABLE public.matriculas_grupo_lnk OWNER TO postgres;
...
ALTER SEQUENCE public.matriculas_grupo_lnk_id_seq OWNER TO postgres;
...
ALTER TABLE public.matriculas_paquete_lnk OWNER TO postgres;
...
ALTER SEQUENCE public.matriculas_paquete_lnk_id_seq OWNER TO postgres;
...
ALTER TABLE public.matriculas_users_lnk OWNER TO postgres;
...
ALTER SEQUENCE public.matriculas_users_lnk_id_seq OWNER TO postgres;
...
ALTER TABLE public.modulos_carrera_lnk OWNER TO postgres;
...
ALTER SEQUENCE public.modulos_carrera_lnk_id_seq OWNER TO postgres;
...
ALTER TABLE public.modulos_cmps OWNER TO postgres;
...
ALTER SEQUENCE public.modulos_cmps_id_seq OWNER TO postgres;
...
ALTER TABLE public.paquetes_grupos_lnk OWNER TO postgres;
...
ALTER SEQUENCE public.paquetes_grupos_lnk_id_seq OWNER TO postgres;
...
ALTER TABLE public.personales OWNER TO postgres;
...
ALTER TABLE public.personales_especialidad_lnk OWNER TO postgres;
...
ALTER SEQUENCE public.personales_especialidad_lnk_id_seq OWNER TO postgres;
...
ALTER SEQUENCE public.personales_id_seq OWNER TO postgres;
...
ALTER TABLE public.personales_user_lnk OWNER TO postgres;
...
ALTER SEQUENCE public.personales_user_lnk_id_seq OWNER TO postgres;
...
ALTER SEQUENCE public.pruebas_id_seq OWNER TO postgres;
...
ALTER TABLE public.publicaciones_cmps OWNER TO postgres;
...
ALTER SEQUENCE public.publicaciones_cmps_id_seq OWNER TO postgres;
...
ALTER TABLE public.semestres_coordinador_1_lnk OWNER TO postgres;
...
ALTER SEQUENCE public.semestres_coordinador_1_lnk_id_seq OWNER TO postgres;
...
ALTER TABLE public.semestres_coordinador_2_lnk OWNER TO postgres;
...
ALTER SEQUENCE public.semestres_coordinador_2_lnk_id_seq OWNER TO postgres;
...
ALTER TABLE public.semestres_director_lnk OWNER TO postgres;
...
ALTER SEQUENCE public.semestres_director_lnk_id_seq OWNER TO postgres;
...
ALTER TABLE public.users_role_lnk OWNER TO postgres;
...
ALTER SEQUENCE public.users_role_lnk_id_seq OWNER TO postgres;
...
1250	u76jdw211s3thi6qdgkbalcq	plugin::content-manager.explorer.create	{}	api::publicacion.publicacion	{"fields": ["titulo", "slug", "tipo", "descripcionCorta", "contenido", "contenido2", "fechaPublicacion", "fechaEventoInicio", "fechaEventoFin", "ubicacion", "destacado", "imagenPrincipal", "galeria", "videosYoutube.url"]}	[]	2025-07-29 21:27:57.427	2025-07-29 21:27:57.427	2025-07-29 21:27:57.427	\N	\N	\N
...
1251	k0nxh426da6fxstylxnome1s	plugin::content-manager.explorer.read	{}	api::publicacion.publicacion	{"fields": ["titulo", "slug", "tipo", "descripcionCorta", "contenido", "contenido2", "fechaPublicacion", "fechaEventoInicio", "fechaEventoFin", "ubicacion", "destacado", "imagenPrincipal", "galeria", "videosYoutube.url"]}	[]	2025-07-29 21:27:57.44	2025-07-29 21:27:57.44	2025-07-29 21:27:57.44	\N	\N	\N
...
1252	bq6nksavoj3t1dzy1wnhdbwy	plugin::content-manager.explorer.update	{}	api::publicacion.publicacion	{"fields": ["titulo", "slug", "tipo", "descripcionCorta", "contenido", "contenido2", "fechaPublicacion", "fechaEventoInicio", "fechaEventoFin", "ubicacion", "destacado", "imagenPrincipal", "galeria", "videosYoutube.url"]}	[]	2025-07-29 21:27:57.444	2025-07-29 21:27:57.444	2025-07-29 21:27:57.444	\N	\N	\N
...
9	xneac7dfo9ebi8kbyutuo4qt	2025-06-10 11:52:19.17	2025-06-20 11:51:09.094	2025-06-20 11:51:09.092	2	2	\N	150 horas [lu, mi, vi@]	\N	2025-08-11	2025-12-23	Academico	t
...
1	wwfg3o6e49a2bcykm2hmglq5	2025-05-28 15:48:46.8	2025-07-26 10:40:25.491	2025-07-26 10:40:25.448	1	1	\N	Estética Personal	Estética Personal	\N	\N	estetica-personal
\.
...
120	20	3	api::especialidad.especialidad	imagen	1
121	19	3	api::especialidad.especialidad	imagenes	1
122	18	3	api::especialidad.especialidad	imagenes	2
\.
...
COPY public.publicaciones (id, document_id, titulo, created_at, updated_at, published_at, created_by_id, updated_by_id, locale, slug, tipo, descripcion_corta, contenido, fecha_publicacion, fecha_evento_inicio, fecha_evento_fin, ubicacion, destacado, contenido_2) FROM stdin;
3	e8msz69b491teu1zrow62yns	Novenario a la Virgen del Carmen	2025-07-29 21:10:27.727	2025-07-29 21:10:27.727	\N	1	1	\N	novenario-virgen-carmen-2025	noticia	\N	\N	2025-07-21	\N	\N	\N	t	\N
4	e8msz69b491teu1zrow62yns	Novenario a la Virgen del Carmen	2025-07-29 21:10:27.727	2025-07-29 21:10:27.727	2025-07-29 21:10:27.746	1	1	\N	novenario-virgen-carmen-2025	noticia	\N	\N	2025-07-21	\N	\N	\N	t	\N
5	f2dmrmm4jal4m9eh31j8zelg	VISION	2025-07-29 21:14:21.502	2025-07-29 21:14:21.502	\N	1	1	\N	visiion	noticia	\N	\N	2025-01-01	\N	\N	\N	f	\N
6	f2dmrmm4jal4m9eh31j8zelg	VISION	2025-07-29 21:14:21.502	2025-07-29 21:14:21.502	2025-07-29 21:14:21.535	1	1	\N	visiion	noticia	\N	\N	2025-01-01	\N	\N	\N	f	\N
7	trjmzv26fqtz8zkzyk731zm8	MISION	2025-07-29 21:15:07.065	2025-07-29 21:15:07.065	\N	1	1	\N	mision	noticia	\N	\N	2025-01-01	\N	\N	\N	f	\N
8	trjmzv26fqtz8zkzyk731zm8	MISION	2025-07-29 21:15:07.065	2025-07-29 21:15:07.065	2025-07-29 21:15:07.084	1	1	\N	mision	noticia	\N	\N	2025-01-01	\N	\N	\N	f	\N
9	ql3k450nh56nq25ukya9lvwj	Se busca personal de servicio	2025-07-29 21:18:30.808	2025-07-29 21:18:30.808	\N	1	1	\N	personal-servicio	aviso	\N	\N	2025-07-30	\N	\N	\N	t	\N
10	ql3k450nh56nq25ukya9lvwj	Se busca personal de servicio	2025-07-29 21:18:30.808	2025-07-29 21:18:30.808	2025-07-29 21:18:30.841	1	1	\N	personal-servicio	aviso	\N	\N	2025-07-30	\N	\N	\N	t	\N
1	yyg2j46wlys43uaig85gjou8	Matricula 2025-2 (Agosto - Diciembre)	2025-07-29 21:08:33.052	2025-07-29 21:55:17.309	\N	1	1	\N	matricula-2025-	aviso	Matricula Abierta para este segundo periodo académico 2025-2 de Agosto a fines de Diciembre, separa con tiempo tu matricula, las vacantes son limitadas...	📢 ¡Matrícula Abierta para el Segundo Periodo Académico 2025-2!\nEl CETPRO SAN MARTÍN DE PORRES informa a la comunidad que ya se encuentra abierta la matrícula para el periodo académico 2025-2, correspondiente a los meses de agosto a diciembre. ¡Es tu oportunidad de iniciar o continuar tu formación técnica con nosotros!\n\n🔔 ¡Vacantes limitadas! Te recomendamos separar tu matrícula con anticipación para asegurar tu ingreso. Nuestro compromiso es brindarte una educación de calidad con formación práctica, moderna y orientada a las exigencias del mercado laboral actual.\n\n💼 Especialidades que ofrecemos:\n\n💇‍♀️ Estética Personal\n🧑‍🍳 Panadería y Pastelería\n🪡 Confección Textil\n🧵 Tejido a Mano y Máquina\n🧑‍💻 Computación\n🪛 Electricidad y Electrónica\nBordado computarizado \nTejido a MAQUINA y a MANO\n🎨 Manualidades y Arte Decorativo\nCarpintería\n\n🎯 Modalidades: Presencial con talleres totalmente equipados y docentes especializados.\n📍 Dirección: [Puedes agregar la dirección aquí si deseas]\n📞 Informes: [Agrega el número de contacto y/o redes sociales]\n\nNo dejes pasar esta oportunidad de potenciar tu desarrollo profesional.\n¡Te esperamos en el CETPRO SAN MARTÍN DE PORRES!	2025-07-21	2025-07-21 00:00:00	2025-09-10 00:00:00	CETPRO "SAN MARTIN DE PORRES"	t	\N
13	yyg2j46wlys43uaig85gjou8	Matricula 2025-2 (Agosto - Diciembre)	2025-07-29 21:08:33.052	2025-07-29 21:55:17.309	2025-07-29 21:55:17.343	1	1	\N	matricula-2025-	aviso	Matricula Abierta para este segundo periodo académico 2025-2 de Agosto a fines de Diciembre, separa con tiempo tu matricula, las vacantes son limitadas...	📢 ¡Matrícula Abierta para el Segundo Periodo Académico 2025-2!\nEl CETPRO SAN MARTÍN DE PORRES informa a la comunidad que ya se encuentra abierta la matrícula para el periodo académico 2025-2, correspondiente a los meses de agosto a diciembre. ¡Es tu oportunidad de iniciar o continuar tu formación técnica con nosotros!\n\n🔔 ¡Vacantes limitadas! Te recomendamos separar tu matrícula con anticipación para asegurar tu ingreso. Nuestro compromiso es brindarte una educación de calidad con formación práctica, moderna y orientada a las exigencias del mercado laboral actual.\n\n💼 Especialidades que ofrecemos:\n\n💇‍♀️ Estética Personal\n🧑‍🍳 Panadería y Pastelería\n🪡 Confección Textil\n🧵 Tejido a Mano y Máquina\n🧑‍💻 Computación\n🪛 Electricidad y Electrónica\nBordado computarizado \nTejido a MAQUINA y a MANO\n🎨 Manualidades y Arte Decorativo\nCarpintería\n\n🎯 Modalidades: Presencial con talleres totalmente equipados y docentes especializados.\n📍 Dirección: [Puedes agregar la dirección aquí si deseas]\n📞 Informes: [Agrega el número de contacto y/o redes sociales]\n\nNo dejes pasar esta oportunidad de potenciar tu desarrollo profesional.\n¡Te esperamos en el CETPRO SAN MARTÍN DE PORRES!	2025-07-21	2025-07-21 00:00:00	2025-09-10 00:00:00	CETPRO "SAN MARTIN DE PORRES"	t	\N
\.
...
21	plugin_upload_metrics	{"weeklySchedule":"25 8 10 * * 6","lastWeeklyUpdate":1753542505033}	object	\N	\N
...
SELECT pg_catalog.setval('public.admin_permissions_id_seq', 1252, true);
...
SELECT pg_catalog.setval('public.admin_permissions_role_lnk_id_seq', 1252, true);
...
SELECT pg_catalog.setval('public.files_folder_lnk_id_seq', 7, true);
...
SELECT pg_catalog.setval('public.files_related_mph_id_seq', 158, true);
...
SELECT pg_catalog.setval('public.publicaciones_id_seq', 13, true);
...
SELECT pg_catalog.setval('public.strapi_database_schema_id_seq', 224, true);
